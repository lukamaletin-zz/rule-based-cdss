package com.lukamaletin.cdss.controller.exception.resolver;

import com.lukamaletin.cdss.controller.exception.AuthorizationException;
import com.lukamaletin.cdss.controller.exception.BadRequestException;
import com.lukamaletin.cdss.controller.exception.ForbiddenException;
import com.lukamaletin.cdss.controller.exception.NotFoundException;
import com.lukamaletin.cdss.model.dto.ErrorResponse;
...
public class ExceptionResolver {
    ...
    public ResponseEntity methodArgumentNotValidException() {
        return new ResponseEntity<>(new ErrorResponse("Validation failed - check all fields!"), HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(DataIntegrityViolationException.class)
    public ResponseEntity dataIntegrityViolationException() {
        return new ResponseEntity<>(new ErrorResponse("Cannot delete - entity is already used in system."), HttpStatus.BAD_REQUEST);
    }
}
